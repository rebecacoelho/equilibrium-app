    ...
    async function handleUserPhotoSelect() {
        ...
        try {
            ...
            if (photoSelected.assets[0].uri) {
                ...
                const fileExtentsion = photoSelected.assets[0].uri.split('.').pop()

                const photoFile = {
                    name: `${user.name}.${fileExtentsion}`.toLowerCase(),
                    uri: photoSelected.assets[0].uri,
                    type: `${photoSelected.assets[0].type}/${fileExtentsion}`
                } as any
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 36 }}>
                  ...
                  <Reminder />
                    ...
                    <Controller 
                        ...
                        render={({ field: { onChange, value } }) => (
                            <Input placeholder="Nome" bg='gray.600' onChangeText={onChange} value={value} errorMessage={errors.name?.message}/>
                        )}
                    />
                    ...
                    <Controller 
                        ...
                        name="email" 
                        render={({ field: { onChange, value } }) => (
                            <Input placeholder="E-mail" bg='gray.600' isDisabled onChangeText={onChange} value={value} />
                        )}
                    />
                ...
                <VStack px={10} mt={12} mb={9}>
                    ...
                    <Controller 
                        ...
                        render={({ field: { onChange } }) => (
                            <Input bg='gray.600' placeholder="Confirma a nova senha" secureTextEntry onChangeText={onChange} errorMessage={errors.confirm_password?.message}/>
                         )}
                    />
